...
@protocol AAudioTrimmerDelegate;

NS_ASSUME_NONNULL_BEGIN

@interface AAudioTrimmerView : UIView
...
// Maximum length for the trimmed Audio
@property (assign, nonatomic) CGFloat maxLength;

// Minimum length for the trimmed Audio
...
@property (weak, nonatomic, nullable) id<AAudioTrimmerDelegate> delegate;
...
@protocol AAudioTrimmerDelegate <NSObject>

@optional
- (void)AudioTrimmerView:(nonnull AAudioTrimmerView *)trimmerView didChangeLeftPosition:(CGFloat)startTime rightPosition:(CGFloat)endTime;
- (void)AudioTrimmerViewDidEndEditing:(nonnull AAudioTrimmerView *)trimmerView;
